...
#include <hwdef.h>
#include <AP_FlashStorage/AP_FlashStorageTypes.h>
...
#if AP_FLASHSTORAGE_TYPE == AP_FLASHSTORAGE_TYPE_F1
// emulate F1/F3 flash
...
// emulate RP2350 flash. The storage size has to be a whole number of the
// 254 byte blocks that type uses, as it is on the real board.
#define HAL_STORAGE_SIZE (65*254)
#define HAL_FLASH_SECTOR_SIZE 64*1024
#define HAL_FLASH_MIN_WRITE_SIZE 256
#define HAL_FLASH_ALLOW_UPDATE 0
#endif
